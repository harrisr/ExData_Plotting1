...
##  NOTE:  on this one, they threw us a curve ball, the second EXAMPLE plot shows
##  basically a continuous plot of all the data points of the "global_active_power"
...
# We *really* only need the data from the columns: "Date" "TIME" and "Global_active_power"
...
dt_pwrconsume <- dt_pwrconsume[   , c("Date", "Time", "Global_active_power")     ]


#str(dt_pwrconsume)
#head(dt_pwrconsume)
#Date     Time Global_active_power
#1: 1/2/2007 00:00:00               0.326
#2: 1/2/2007 00:01:00               0.326
#3: 1/2/2007 00:02:00               0.324
#4: 1/2/2007 00:03:00               0.324
#5: 1/2/2007 00:04:00               0.322
#6: 1/2/2007 00:05:00               0.320
# CHECKIT:
#summary(dt_pwrconsume)
#Date               Time           Global_active_power
#Length:2880        Length:2880        Min.   :0.220      
#Class :character   Class :character   1st Qu.:0.320      
#Mode  :character   Mode  :character   Median :1.060      
#Mean   :1.213      
#3rd Qu.:1.688      
#Max.   :7.482  
...
# *** NOW *** we can make POSIXct date that has DATE and TIME smushed together
# for plotting that continuous line of all the data values
